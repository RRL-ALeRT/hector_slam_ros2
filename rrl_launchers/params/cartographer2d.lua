...
POSE_GRAPH.optimize_every_n_nodes = 90--320 -- Decrease --original 1 | 90 (it should not be too large or there will be a lot of problem)
...
TRAJECTORY_BUILDER_2D.max_range = 90. -- Decrease
